...
MaterialColor appPrimaryColor = Colors.deepOrange;
...
TextStyle normal_h1Style = TextStyle(color: appTextColor, fontSize: 19);
TextStyle normal_h2Style = TextStyle(color: appTextColor, fontSize: 17);
TextStyle normal_h3Style = TextStyle(color: appTextColor, fontSize: 15);
TextStyle normal_h4Style = TextStyle(color: appTextColor, fontSize: 13);
TextStyle normal_h5Style = TextStyle(color: appTextColor, fontSize: 11);
